                    ...
                    <div key={msg.id} className="text-sm">
                        {msg.isSystem ? (
                            ...
                            <>
                                ...
                                <div className="inline-block px-3 py-2 rounded-xl rounded-tl-none text-sm" style={{ style: 'var(--text-color)', background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.07)' }}>
                                    {msg.text}
                                </div>
                            </>
                        )}
